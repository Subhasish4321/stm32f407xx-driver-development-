...
void SPI2_Inits(void)
{
	...
	SPI2handle.SPI_Config.SPI_SclkSpeed = SPI_SCK_SPEED_DIV32;
	SPI2handle.SPI_Config.SPI_DFF = SPI_DFF_8BITS;
	SPI2handle.SPI_Config.SPI_CPOL = SPI_CPOL_LOW;
	SPI2handle.SPI_Config.SPI_CPHA = SPI_CPHA_LOW;
	SPI2handle.SPI_Config.SPI_SSM = SPI_SSM_DISABLE; //Hardware slave management enabled for NSS pin
...
int main(void)
{
	...
	*/
	...
	SPI_IRQ_IT_Config(IRQ_NO_SPI2,ENABLE);
	...
	while(1){
		...
		GPIO_IRQ_IT_Config(IRQ_NO_EXTI9_5,DISABLE);

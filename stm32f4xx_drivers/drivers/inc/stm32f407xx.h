...
/**
 * i2C Register definition structure for I2Cx peripheral
 */
typedef struct
{
    uint32_t I2C_CR1; /*I2C control register 1 */
	uint32_t I2C_CR2; /*I2C control register 2 */
	uint32_t I2C_OAR1;/*i2c own address register 1,stores the address of the slave in slave mode.*/
	uint32_t I2C_OAR2;/*i2c own address register 2,in master mode the address is generated by master itself by software so no need to store the address on hardware register.*/
...
#define I2C_CR1_PE          0
#define I2C_CR1_NOSTRETCH   7  /* Clock stretching is the ability of the slave to hold the clock down when it's busy */
#define I2C_CR1_START       8
#define I2C_CR1_STOP        9
#define I2C_CR1_ACK        10
#define I2C_CR1_SWRST      15

#define I2C_CR2_FREQ        0   /*FREQUENCY*/
...
#define I2C_SR1_TIMEOUT 12 /*TIMEOUT*/
